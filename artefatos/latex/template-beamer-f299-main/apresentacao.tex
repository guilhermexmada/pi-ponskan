...
\begin{frame}[b]{Problematização}
  ...
  {\fontsize{4}{5}\selectfont\textit{Fonte: USDA (2025)}\hfill\textcolor{white}{Imagem: Descrição da imagem}}
\end{frame}
}
...
\begin{frame}[t]{Metodologia}
  ...
  \scriptsize 
  (A) O produtor rural captura de 1-4 imagens no app Mobile. As imagens são enviadas para nossa API Rest.
\end{frame}
