...
\label{fig:diagrama-caso-uso}
 \includegraphics[width=0.8\textwidth]{imgs/caso_de_uso.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{imgs/classes_blackspot.png}
...
O diagrama de objetos mostra as instâncias das classes do sistema:

% \begin{verbatim}
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{imgs/objetos_blackspot.png}
