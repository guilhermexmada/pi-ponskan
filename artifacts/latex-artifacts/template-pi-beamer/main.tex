...
\node (C) [draw, rectangle, below of=B, node distance=1cm] {Pinta Preta (\emph{Phyllosticta} \emph{citricarpa})};
...
\Large {Pazoti, 2005} \\[1cm]

\justifying 
{\normalsize Objetivos gerais pouco operacionais, específicos ausentes ou mal apresentados.  
Há redundâncias e inversão entre o que é produto e o que é método.}\\[1cm]
\end{frame}
% Estado da Arte 01 ============================
